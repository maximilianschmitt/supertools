...
read -p "Choose a Supertools username: " ST_OWNER_NAME
read -p "Choose a login email: " ST_OWNER_EMAIL
read -s -p "Choose a password: " ST_OWNER_PASSWORD
...
Now go to $SUPERTOOLS_DOMAIN and login with $ST_OWNER_EMAIL.
